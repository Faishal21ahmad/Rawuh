            ...
            <ul class="pt-4 space-y-2 border-t border-gray-700">
                <li class="py-1">
                    <a href="/dashboard" class="flex items-center p-2 text-base font-normal rounded-lg text-white hover:bg-gray-700">
                        <i class="text-xl fi fi-ss-chart-pie-alt flex items-center text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
                ...
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base font-normal transition duration-75 rounded-lg group  text-white hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        <i class="fi fi-sr-notebook text-xl flex items-center text-gray-400 hover:bg-gray-700"></i>
                    ...
                    <ul id="dropdown-example" class="menupesan  py-2 space-y-2 {{ Request::is('dashboard','menu','meja','kategori','pembayaran') ? 'hidden' : ''}}">
                        <li>
                            <a href="/pesanan" class="menuopen flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-8 group text-white hover:bg-gray-700"><i class="fi fi-sr-add-document text-xl flex items-center text-gray-400 hover:bg-gray-700 mr-2"></i>Pesanan Masuk</a>
                        </li>
                        <li>
                            <a href="/pesanan/proses" class="menuopen flex items-center w-full p-2 text-base font-normal transition duration-75 rounded-lg pl-8 group text-white hover:bg-gray-700"><i class="fi fi-sr-file-chart-pie text-xl flex items-center text-gray-400 hover:bg-gray-700 mr-2"></i>Pesanan Proses</a>
                        </li>
                        <li>
                            <a href="/pesanan/selesai" class="menuopen flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-8 group text-white hover:bg-gray-700"><i class="fi fi-sr-assept-document text-xl  flex items-center text-gray-400 hover:bg-gray-700 mr-2"></i>Pesanan Selesai</a>
                        </li>
                    </ul>
                </li>
